...
export default function CategoriesPage() {
  ...
  const getCategoryImage = (slug: string) => {
    ...
    const categoryImages: { [key: string]: string } = {
      ...
      smartphones: "/images/categories/smartphones.svg",
      accessories: "/images/categories/accessories.svg",
      gaming: "/images/categories/gaming.svg",
      headphones: "/images/categories/headphones.svg",
      tablets: "/images/categories/tablets.svg"
    }
    return categoryImages[slug] || "/images/placeholder.svg"
  }

  const getCategoryIcon = (_slug: string) => {
