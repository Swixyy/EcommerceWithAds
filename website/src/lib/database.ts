...
export async function getPersonalizedAdvertisement(userPreferences: any, position: string) {
  ...
  const mockAds = {
    top: {
      ...
      imageUrl: "/images/ads/laptop-sale.jpg",
...
export async function getPersonalizedRecommendations(userPreferences: any, limit: number) {
